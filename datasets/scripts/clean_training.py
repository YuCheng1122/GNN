...
def get_metadata_map():
    ...
    """
    metadata_file = "/home/tommy/Projects/cross-architecture/datasets/csv/Cross-arch_Dataset_with_Additional_20250428200830.csv"
    try:
...
def process_all_data():
    ...
    benign_output_prefix = os.path.join(output_dir, f"{current_date}_cleaned_all_benign")
    ...
    malware_output_prefix = os.path.join(output_dir, f"{current_date}_cleaned_all_malware")
    ...
    combined_output_prefix = os.path.join(output_dir, f"{current_date}_cleaned_all_combined")
