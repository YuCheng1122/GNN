...
def main():
    ...
    test_csv_path = "/home/tommy/Projects/pcodeFcg/dataset/csv/test_arm.csv"
    train_dir = "/home/tommy/Projects/pcodeFcg/vector/contrastive/GNN/arm/train"
    test_dir = "/home/tommy/Projects/pcodeFcg/vector/contrastive/GNN/arm/test"
    ...
    print(f"Train Shape{train_graphs[0].x.shape}")
    ...
    # 保存模型
    torch.save(model.state_dict(), "gcn_model_450.pth")
    ...
    plt.tight_layout()
    plt.savefig('training_curves_450.png')
    plt.show()
    ...
    # Confusion Matrix using original class labels
    ...
    plt.tight_layout()
    plt.savefig("confusion_matrix_450.png")
    plt.show()
